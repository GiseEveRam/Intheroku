...
<html lang="es">
        ...
        <div class="row">
          <div class="d-flex justify-content-end col-lg-3">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <img src="../Integrador/imagenes/codoacodo.png" style="width: 100px;">
              </li>
              <li class="nav-item">
          ...
          <div class="col-lg-9">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <a class="nav-link" href="#" style="color: white;"><h10>La Conferencia</h10></a>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#" style="color: rgb(59, 107, 79);"><h10>Comprar tickets</h10></a>
                </li>
              </li>  
            </ul>
           </div>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active alto" >
          <img src="../nint2/imagenes/ba1.jpg" class="d-block w-100 h-100" alt="...">
        ...
        <div class="carousel-item">
          <img src="../nint2/imagenes/ba2.jpg" class="d-block w-100 h-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="../nint2/imagenes/ba3.jpg" class="d-block w-100 h-100" alt="...">
        </div>
        </div>
      </div>
   </section>
  ...
  <div class="container col-lg-3 row align-items-center">
    ...
    <h4>ORADORES</h4>
      ...
      <div class="d-flex justify-content-betweens">
        <div class="container row">
              ...
              <div class="card">
                <img src="../Integrador/imagenes/steve.jpg">
                <div class="containercol-lg-3">
              ...
              <div class="card">
                <img src="../Integrador/imagenes/bill.jpg">
                <div class="containercol-lg-3">
                  <span class="badge bg-warning text-dark">JavaScript</span>
                  <span class="badge bg-primary">React</span>
                </div>
              ...
              <div class="card">
                <img src="../Integrador/imagenes/ada.jpeg">
                <div class="containercol-lg-3">
      ...
      <br>
    <div class="container-fluid text-white pantalla_dividida">
      <div class="row">
        <div class="col-lg-5 border border-2">
          <img src="../Nintreg/honolulu.jpg" width="600px" alt="100px">
        </div>
      ...
      <br>
      <div class="container col-lg-4 row align-items-center">
      <h12>CONVIERTETE EN UN ORADOR</h12>
      <h4>ORADOR</h4>
    </div>
      <div class="container col-lg-6 row align-items-center">
      <a><p>Anotate como orador para dar una charla iginite. Cuentanos de que quieres hablar!</p></a>
    </div>
    <br>
    <div class="row g-2 ">
      <div class="col">
    ...
    <div class="container-fluidd-flex p-3 bd-highlight" style="background-color: rgb(69, 69, 70);">
              <div class="col-lg-12">
               <ul class="nav nav-pills card-header-pills">
                <li class="nav-item container col-lg-2">
                <a class="nav-link" href="#" style="color: white;"><h10>Preguntas<br>frecuentes</h10></a>
                  </li>
